...
def format_taifex_message(data: dict) -> str:
    ...
    try:
        numeric_change = parse_number(change)
...
def handle_text_message(event):
    ...
    try:
        stop_loss_command = (
            parse_stop_loss_command(user_text)
        )
        ...
        if user_text in {
            ...
            reply_text = format_taifex_message(
                data
            )

        elif stop_loss_command:
            stop_points, contracts = (
                stop_loss_command
            )
